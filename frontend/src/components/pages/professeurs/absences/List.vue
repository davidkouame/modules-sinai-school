                    ...
                    <tr v-if="countAbsences" v-for="(absenceeleve, index) in absenceseleves">
                      ...
                      <td>
                        <div class="row">
                          ...
                          <a
                            :href="'#/absences/update/'+absenceeleve.id"
                          ...
                          <a
                            id="show-modal"
                            @click="showModalF(absenceeleve.id)"
  ...
  methods: {
    fetch(pageNum, search = null) {
      ...
      let params = [
        ...
        {
          key: "section_annee_scolaire_id",
          value: this.sectionAnneeScolaireId
        },
        { key: "professeur_id", value: this.$cookies.get("professeurId") }
      ];
      this.$store.dispatch("absenceselevesP", {
        pageNum: pageNum,
