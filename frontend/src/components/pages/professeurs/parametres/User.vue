  ...
  <div id="app" class="container">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
        ...
        @click="selected = 1"
        role="tab" aria-controls="home" aria-selected="true">User connexion</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" 
        ...
        data-toggle="tab" 
        href="javascript:void(0)" 
        role="tab" aria-controls="profile" aria-selected="false">Classes</a>
      </li>
    </ul>
    <div class="tab-content" id="myTabContent">
      ...
      id="home" role="tabpanel" aria-labelledby="user-connexion">
        <form>
...
export default {
  ...
  created(){
    ...
    this.$store.dispatch('getClassesByProfesseurIdP', localStorage.getItem('professeurId'));
  },
  methods: {
    updateUser(){
