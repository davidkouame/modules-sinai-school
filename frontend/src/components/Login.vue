    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form" v-on:submit="connection">
          ...
          <div class="alert alert-danger" v-show="errorMessage" style="background-color: #FF8F5E;
...
font-size: 14px;
margin-bottom: 16px;
font-family: 'Muli', Arial, sans-serif;">{{ errorMessage }}</div>
          <div
          ...
          <a class="wrap-input100 validate-input" style="margin-left: 93px;" href="#/forgot-password">Mot de passe oublié </a>
