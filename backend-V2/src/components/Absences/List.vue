          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a
                ...
                v-if="checkPermission('ADD_ABSENCE')"
              >Ajouter</a>
            </div>
          </div>
        </div>
        ...
        <tbody>
          <tr v-if="absences" v-for="(absence, index) in absences">
            ...
            <td>
              ...
              <a
                :href="'#/absences/edit/'+absence.id"
                class="btn btn-icon btn-success btn-sm" v-if="checkPermission('EDIT_ABSENCE')"
              >
                <!---->
              ...
              <a
                id="show-modal"
                @click="showModalF(absence.id)"
                type="button"
                class="btn btn-icon btn-danger btn-sm btn-delete" v-if="checkPermission('DELETE_ABSENCE')"
              >
                <!---->
          ...
          <tr v-show="showEmptySentenceAbsence">
