            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select v-model="absence.eleve_id" class="form-control">
                  ...
                  >{{ eleve.name }} {{ eleve.surname }}</option>
                </select>
                <!---->
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!---->
                <datetime
                  v-model="absence.heure_debut_cours"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!---->
                <datetime
                  v-model="absence.heure_fin_cours"
                  input-class="form-control"
                  type="datetime"
                ></datetime>
                <!---->
...
export default {
  ...
  created() {
    ...
    this.$store.dispatch("getAllEleves", {
      payload: 0,
      search: [
  ...
  methods: {
    saveAbsence() {
      ...
      let data = {
        ...
        heure_debut_cours: this.absence.heure_debut_cours
          .split(".")[0]
          .replace("T", " "),
        heure_fin_cours: this.absence.heure_fin_cours
          .split(".")[0]
          .replace("T", " "),
