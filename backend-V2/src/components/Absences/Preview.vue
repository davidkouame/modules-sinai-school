      ...
      <div class="row">
        <div class="col-md-12">
          <form v-if="absence">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text" :value="absence.raisonabsence.libelle"
                        disabled
                      />
                      <!---->
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        :value="absence.heure_debut_cours"
                        disabled
                      />
                      <!---->
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <!---->
                      <textarea class="form-control"  disabled>{{ absence.commentaire }}</textarea>
                      <!---->
                    </div>
                  </div>
                  <div class="col-md-6">
                ...
                <a href="#/absences" class="btn btn-danger btn-delete float-right">Retour</a>
              </form>
        </div>
      </div>
  </card>
