                ...
                <div class="float-right">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      &nbsp;
                      <button type="submit" class="btn btn-primary btn-delete btn-add" :disabled="valueDisabled">Modifier <div v-bind:class="{'spinner-border-customize': valueDisabled}"></div></button>
                    </div> 
                  </div>
                </div>
              </form>
