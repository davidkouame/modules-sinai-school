      ...
      <div class="col-sm-6">
        <div class="float-right">
          <div class="row">
            ...
            <div class="col-md-4">
              <a :href="'#/sections-annee-scolaire/add/'" class="btn btn-primary btn-add">Ajouter</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <tbody>
          <tr v-if="sectionsanneescolaire" v-for="(sectionanneescolaire, index) in sectionsanneescolaire">
            ...
            <td>
              ...
              <a id="show-modal" @click="showModalF(sectionanneescolaire.id)" type="button" class="btn btn-icon btn-danger btn-sm btn-delete">
