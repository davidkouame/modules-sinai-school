          ...
          <div class="row">
            <div class="col-md-8">
              <input
                ...
                placeholder="Rechercher une abonnement"
                @keyup="searchModel"
                v-model="search"
              />
            </div>
            <div class="col-md-4">
              <a
                :href="'#/abonnements/add/'"
                class="btn btn-primary btn-add"
                v-if="checkPermission('ADD_NOTE')"
              >Ajouter</a>
            </div>
          </div>
        </div>
        ...
        <tbody>
          <tr v-if="abonnements" v-for="(abonnement, index) in abonnements">
            ...
            <td>
              ...
              <a
                :href="'#/abonnements/edit/'+abonnement.id"
                class="btn btn-icon btn-success btn-sm"
                v-if="checkPermission('EDIT_NOTE')"
              >
                <!---->
              ...
              <a
                id="show-modal"
                @click="showModalF(abonnement.id)"
                type="button"
                class="btn btn-icon btn-danger btn-sm btn-delete"
                v-if="checkPermission('DELETE_NOTE')"
              >
                <!---->
