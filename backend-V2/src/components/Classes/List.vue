          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a
                ...
                v-if="checkPermission('ADD_CLASSE')"
              >Ajouter</a>
            </div>
          </div>
        </div>
    ...
    <div class="col-sm-12 card-body-body">
      <table class="table table-d">
        ...
        <tbody>
          <tr v-if="classes" v-for="(classe, index) in classes">
            ...
            <td>
              ...
              <a
                ...
                v-if="checkPermission('EDIT_CLASSE')"
              >
                <!---->
              ...
              <a
                id="show-modal"
                @click="showModalF(classe.id)"
                type="button"
                class="btn btn-icon btn-danger btn-sm btn-delete"
                v-if="checkPermission('DELETE_CLASSE')"
              >
                <!---->
          ...
          <tr v-show="showEmptySentenceClasse">
