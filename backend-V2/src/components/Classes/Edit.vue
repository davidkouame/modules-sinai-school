                          ...
                          <div class="col-12">
                            <div class="col-sm-12">
                                <div class="float-right">
                                  <div class="row">
                                    <div class="col-md-4">
                                      <a :href="'#/classes-matieres-professeurs/add/'+classe_id" class="btn btn-primary btn-add">Ajouter</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <tbody>
                                <tr v-if="classesprofesseursmatieres" v-for="(classeprofesseurmatiere, index) in  classesprofesseursmatieres">
                                  ...
                                  <td>
                                    ...
                                    <a id="show-modal" @click="showModalF(classeprofesseurmatiere.id)"  class="btn btn-icon btn-danger btn-sm btn-delete">
                        ...
                        <div class="col-12">
                          <div class="col-sm-12">
                            <div class="float-right">
                              <div class="row">
                                <div class="col-md-4">
                                  <a :href="'#/eleves-classes/add/'+classe_id"class="btn btn-primary btn-add">Ajouter</a>
                                </div>
                              </div>
                            </div>
                          </div>
                          <table class="table table-d">
                            ...
                            <tbody>
                              <tr v-if="elevesclasses" v-for="(eleveclasse, index) in elevesclasses">
                                ...
                                <td>
                                  <a id="show-modal" @click="showModalRemoveEleve(eleveclasse.id)"  class="btn btn-icon btn-danger btn-sm btn-delete">
                                    <!----><i class="fa fa-times"></i><!---->
                                  </a>
                                </td>
                              </tr>
