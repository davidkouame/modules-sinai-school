          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!---->
                <input class="form-control" type="text" v-model="classe.reference" disabled />
                <!---->
              </div>
            </div>
            <div class="col-md-6">
                ...
                >
                  <div class="col-12">
                    <div class="col-sm-12">
                      <div class="float-right">
                        <div class="row">
                          <div class="col-md-4">
                            <a
                              :href="'#/classes-matieres-professeurs/add/'+classe_id"
                    ...
                    <table class="table table-d">
                      ...
                      <tbody>
                        <tr
                          v-if="classesprofesseursmatieres"
                          v-for="(classeprofesseurmatiere, index) in  classesprofesseursmatieres"
                        >
                          ...
                          <td>
                            <a
                              :href="'#/classes-matieres-professeurs/edit/'+classeprofesseurmatiere.id"
                            ...
                            <a
                              id="show-modal"
                              @click="showModalF(classeprofesseurmatiere.id)"
                    ...
                    <div class="col-sm-12">
                      <div class="float-right">
                        <div class="row">
                          <div class="col-md-4">
                            <a
                              :href="'#/eleves-classes/add/'+classe_id"
                              class="btn btn-primary btn-add"
                            >Ajouter</a>
                          </div>
                        </div>
                    ...
                    <table class="table table-d">
                      ...
                      <tbody>
                        <tr v-if="elevesclasses" v-for="(eleveclasse, index) in elevesclasses">
                          ...
                          <td>
                            <a
                              :href="'#/classes-eleves/'+eleveclasse.id"
                            >{{ eleveclasse.eleve.matricule }}</a>
                          </td>
                          ...
                          <td>
                            <a
                              id="show-modal"
                              @click="showModalRemoveEleve(eleveclasse.id)"
                              class="btn btn-icon btn-danger btn-sm btn-delete"
                            >
                              <!---->
                              <i class="fa fa-times"></i>
                        ...
                        <tr v-show="showEmptySentenceEleveClasse">
...
export default {
  ...
  created() {
    ...
    this.$store.dispatch("getMatieresByClasse", {
      classeId: this.$route.params.id
    });
  ...
  methods: {
    ...
    dispatchElevesClasses(pageNum, search = null) {
      ...
      let params = [
        ...
        { key: "classe_id", value: this.classe_id }
      ];
