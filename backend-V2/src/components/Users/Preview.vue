          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!---->
                <input type="password" class="form-control" v-model="password_confirmation" disabled/>
                <!---->
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <!---->
                <select v-model="user.role_id" class="form-control" disabled>
