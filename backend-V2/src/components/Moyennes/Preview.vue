      ...
      <div class="row">
        <div class="col-md-12">
          <form v-if="moyenne">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        v-bind:value="moyenne.eleve.name && moyenne.eleve.surname? moyenne.eleve.name+' '+moyenne.eleve.surname : ''"
                        disabled
                      />
                      <!---->
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        v-bind:value="moyenne.sectionanneescolaire ? moyenne.sectionanneescolaire.libelle : '' "
                        disabled
                      />
                      <!---->
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        v-bind:value="moyenne.classe ? moyenne.classe.libelle : '' "
                        disabled
                      />
                      <!---->
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        v-bind:value="moyenne.anneescolaire ? moyenne.anneescolaire.libelle : '' "
                        disabled
                      />
                      <!---->
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        class="form-control"
                        type="text"
                        v-bind:value="moyenne.typemoyenne ? moyenne.typemoyenne.libelle : '' "
                        disabled
                      />
                      <!---->
                    </div>
                ...
                <a href="#/moyennes" class="btn btn-danger btn-delete float-right" >Retour</a>
              </form>
        </div>
      </div>
  </card>
