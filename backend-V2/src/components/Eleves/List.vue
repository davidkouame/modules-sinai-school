      ...
      <div class="col-sm-6">
        <div class="float-right">
          <div class="row">
            ...
            <div class="col-md-4">
              <a :href="'#/eleves/add/'" class="btn btn-primary btn-add" v-if="checkPermission('ADD_ELEVE')">Ajouter</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <tbody>
          <tr v-if="eleves" v-for="(eleve, index) in eleves">
            ...
            <td>
              ...
              <a :href="'#/eleves/edit/'+eleve.id" class="btn btn-icon btn-success btn-sm" v-if="checkPermission('EDIT_ELEVE')">
                <!---->
              ...
              <a
                id="show-modal"
                @click="showModalF(eleve.id)"
                type="button"
                class="btn btn-icon btn-danger btn-sm btn-delete" v-if="checkPermission('DELETE_ELEVE')"
              >
                <!---->
          ...
          <tr v-show="showEmptySentenceEleve">
