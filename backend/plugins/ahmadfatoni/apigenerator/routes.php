...
Route::resource('api/v1/usergroups', 'AhmadFatoni\ApiGenerator\Controllers\API\UserGroupController', ['except' => ['destroy', 'create', 'edit']]);
Route::get('api/v1/usergroups/{id}/delete', ['as' => 'api/v1/usergroups.delete', 'uses' => 'AhmadFatoni\ApiGenerator\Controllers\API\UserGroupController@destroy']);
Route::resource('api/v1/usersgroups', 'AhmadFatoni\ApiGenerator\Controllers\API\UsersGroupsController', ['except' => ['destroy', 'create', 'edit']]);
Route::get('api/v1/usersgroups/{id}/delete', ['as' => 'api/v1/usersgroups.delete', 'uses' => 'AhmadFatoni\ApiGenerator\Controllers\API\UsersGroupsController@destroy']);
Route::resource('api/v1/roles', 'AhmadFatoni\ApiGenerator\Controllers\API\RoleController', ['except' => ['destroy', 'create', 'edit']]);
Route::get('api/v1/roles/{id}/delete', ['as' => 'api/v1/roles.delete', 'uses' => 'AhmadFatoni\ApiGenerator\Controllers\API\RoleController@destroy']);
Route::resource('api/v1/permissions', 'AhmadFatoni\ApiGenerator\Controllers\API\PermissionController', ['except' => ['destroy', 'create', 'edit']]);
Route::get('api/v1/permissions/{id}/delete', ['as' => 'api/v1/permissions.delete', 'uses' => 'AhmadFatoni\ApiGenerator\Controllers\API\PermissionController@destroy']);
Route::resource('api/v1/permissionsroles', 'AhmadFatoni\ApiGenerator\Controllers\API\PermissionRoleController', ['except' => ['destroy', 'create', 'edit']]);
Route::get('api/v1/permissionsroles/{id}/delete', ['as' => 'api/v1/permissionsroles.delete', 'uses' => 'AhmadFatoni\ApiGenerator\Controllers\API\PermissionRoleController@destroy']);